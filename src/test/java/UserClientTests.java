...
public class UserClientTests {
    ...
    public void verifyValidUser() {
        ...
        Assert.assertEquals(new CommonClient().userClient.getStatusCode(TestData.VALIDUSER),200,"wronng statuscode");
    }
    ...
    public void verifyInValidUser() {
        ...
        Assert.assertEquals(new CommonClient().userClient.getStatusCode(TestData.INVALIDUSER),200,"wronng statuscode");
    }

    @Test(description = "verify user service for invalid numeric user")
    public void testUserId()  {
        Assert.assertEquals(new CommonClient().userClient.getUserId(TestData.VALIDUSER),TestData.VALIDUSERID,"wronng statuscode");
